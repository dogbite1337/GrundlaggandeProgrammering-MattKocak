# GrundlaggandeProgrammering-MattKocak

Adding instructions of project for future reference

Betygsgrundande individuell inlämningsuppgift: Grundläggande programmering

Obs! Denna uppgift genomför du individuellt/enskilt. Du får lov att samarbeta med andra i klassen, genom att diskutera och jämföra era lösningar. Du måste dock lämna in din egen lösning (dvs. inte kopiera någon annans kod).
...
Lämna in på PingPong i tid (senast söndag 21 februari 23.55)

Betygskrav VG-nivå:
Samtliga G-betygskrav samt kraven på Spelgång och spelregler (VG-nivå).
